...
public class Test {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Serialize to bloom_filter to disk.
        {
            ...
            bloomFilter.add("ni".getBytes(StandardCharsets.UTF_8));System.out.println(bloomFilter.testString("Hello World")); // true
            ...
            System.out.println(bloomFilter.testString("1L")); // true
